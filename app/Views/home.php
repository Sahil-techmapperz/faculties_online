    ...
    <header>
        <div
            ...
            <div class="relative z-10 flex flex-col items-center gap-6 text-center px-4">
                <!-- Text Content -->
                <div class="max-w-6xl">
                    <h1 class="text-3xl md:text-5xl lg:text-5xl font-bold text-white mb-4">
        ...
        <div class="grid grid-cols-5 my-4">
            ...
            <div class="m-auto">
                <ul class="flex flex-col justify-center items-center gap-2">
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>">Academic Writing</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Commerce</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> French Language</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Academic Writing</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> .net</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Jquery & Javascript </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> C#</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> iOS App </a></li>
                </ul>
            </div>

            <div class="m-auto">
                <ul class="flex flex-col justify-center items-center gap-2">
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>">Adobe Photoshop</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Biology</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> German</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Control System </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Communication Skills </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> PHP </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Adobe Photoshop</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Adobe Photoshop </a></li>
                </ul>
            </div>
            ...
            <div class="m-auto">
                <ul class="flex flex-col justify-center items-center gap-2">
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>">HTML/CSS</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Physics </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Mathematic</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Political Science </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> HTML/CSS</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Zoology </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Science </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Art & Craft </a></li>
                </ul>
            </div>

            <div class="m-auto">
                <ul class="flex flex-col justify-center items-center gap-2">
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>">React Nativ</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Flutter </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Company Law </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Financial Management </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> English </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> DBMS </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Music </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> HTML/CSS </a></li>
                </ul>
            </div>
            ...
            <div class="m-auto">
                <ul class="flex flex-col justify-center items-center gap-2">
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>">C/C++</a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Computer Networking </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Basic Electronic </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Business Management </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> Fluid Mechanics </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> History </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>">Income Tax </a></li>
                    <li class="text-base text-gray-600 font-semibold hover:text-[#0077FE] cursor-pointer w-fit"><a href="<?= base_url('tutor') ?>"> C/C++ </a></li>
                </ul>
            </div>
